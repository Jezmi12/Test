# В этом коде я добавил метод find_most_reliable_path(),
# который принимает начальные и конечные координаты башен
# и возвращает наиболее надежный путь (минимальное количество переходов) между ними.
...
print("Самый надежный путь:", path)
